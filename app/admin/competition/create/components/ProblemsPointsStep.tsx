...
export default function ProblemsPointsStep({
    ...
    // Fetch ALL problem banks on mount (admin can see all)
    useEffect(() => {
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4 pt-6 border-t border-slate-200">
                <div>
                    ...
                    <p className="text-sm text-slate-600">Choose problems from all problem banks</p>
                </div>
                            ...
                            <div className="border border-slate-200 rounded-lg divide-y divide-slate-200 max-h-96 overflow-y-auto">
                                {bankProblems.map((problem) => {
                                    ...
                                    return (
                                        <div
                                            key={problem.id}
                                            className={`p-4 ${isSelected ? "bg-purple-50" : "bg-white hover:bg-slate-50"} transition-colors`}
                                        >
                                            <div className="flex items-start gap-3">
                                                <input
                                                    type="checkbox"
