      ...
      <aside className="w-64 bg-white border-r border-slate-200 fixed h-full overflow-y-auto">
        <div className="p-6">
          ...
          <nav className="space-y-1">
            <Link href="/admin" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 rounded-lg transition-colors">
            ...
            <Link href="/admin/problem-bank" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-white bg-purple-600 rounded-lg">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Link href="/admin/settings" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 rounded-lg transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <main className="flex-1 ml-64 p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-slate-800 mb-2">Add Problem</h1>
            <p className="text-slate-600">Create a new problem for this problem bank</p>
          </div>

          {/* Form Card */}
          <div className="bg-white rounded-lg border border-slate-200 p-8 shadow-sm">
            <AddProblemForm problemBankId={params.id} />
          </div>
        </div>
      </main>
    </div>
