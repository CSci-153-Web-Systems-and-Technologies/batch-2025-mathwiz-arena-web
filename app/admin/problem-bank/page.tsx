...
export default async function AdminProblemBankPage() {
    ...
    // Fetch ALL problem banks from ALL organizers
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex justify-between items-center mb-8">
                        <div>
                            ...
                            <p className="text-slate-600">Manage all problem banks across all organizers</p>
                        </div>
                    </div>
                    ...
                    {error ? (
                        ...
                        <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
                            ...
                            <p className="text-slate-600 mb-6">
                                No organizers have created problem banks yet
                            </p>
                        </div>
                    )}
                </div>
