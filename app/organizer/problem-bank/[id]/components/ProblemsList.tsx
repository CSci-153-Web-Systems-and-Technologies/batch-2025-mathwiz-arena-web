    ...
    <div className="divide-y divide-slate-200 dark:divide-slate-700">
      {problems.map((problem, index) => (
        <Link
          ...
          className="block p-4 md:p-6 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors group"
        >
          <div className="flex items-start gap-3 md:gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-2">
                <span className={`text-[10px] sm:text-xs font-medium px-2 py-0.5 sm:py-1 rounded border capitalize ${getDifficultyColor(problem.difficulty)}`}>
                  {problem.difficulty}
                </span>
