    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <div className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <h1 className="text-3xl font-bold text-slate-800 dark:text-white">Competition History</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg bg-[#f49700]/10 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800 dark:text-white">{totalCompetitions}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800 dark:text-white">{endedCount}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800 dark:text-white">{totalParticipants}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800 dark:text-white">{overallAvgRating}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {enrichedCompetitions.length > 0 ? (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="inline-block px-2 py-1 text-xs font-semibold rounded-full bg-slate-200 dark:bg-slate-600 text-slate-600 dark:text-slate-300">
                          Ended
                        </span>
                        {competition.competition_mode === "live" ? (
                          <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-400">
                            Live
                          </span>
                        ) : (
                          <span className="inline-block px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400">
                            Scheduled
                          </span>
                        )}
                      </div>
                      <div className="flex items-center gap-4 text-sm text-slate-600 dark:text-slate-400">
                        <span className="flex items-center gap-1">
                          ...
                          {formatDate(competition.start_datetime)} at {formatTime(competition.start_datetime)}
                        </span>
                        <span className="flex items-center gap-1">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        {competition.average_rating !== undefined ? (
                          <>
                            ...
                            <p className="text-xl font-bold text-[#f49700] flex items-center gap-1">
                      ...
                      <Link
                        ...
                        className="px-4 py-2 text-sm font-medium text-[#f49700] bg-[#f49700]/10 rounded-lg hover:bg-[#f49700]/20 transition-colors"
                      >
                        View Details
                      </Link>
                    </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
            <div className="p-12 text-center">
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">No Competition History Yet</h2>
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#f49700] text-white font-semibold rounded-lg hover:bg-[#d68400] transition-colors"
              >
