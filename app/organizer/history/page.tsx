    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="bg-white border-b border-slate-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <h1 className="text-3xl font-bold text-slate-800">Competition History</h1>
          <p className="text-slate-600 mt-1">View your past competitions and their performance</p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800">{totalCompetitions}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800">{endedCount}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800">{overallAvgRating}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {enrichedCompetitions.length > 0 ? (
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-200">
              <h2 className="text-lg font-semibold text-slate-800">Past Competitions</h2>
            </div>
            <div className="divide-y divide-slate-200">
              {enrichedCompetitions.map((competition) => (
                <div key={competition.id} className="px-6 py-4 hover:bg-slate-50 transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="inline-block px-2 py-1 text-xs font-semibold rounded-full bg-slate-200 text-slate-600">
                          Ended
                        </span>
