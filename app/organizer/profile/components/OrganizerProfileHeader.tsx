        ...
        <>
            {isOwnProfile && onEditProfile && (
                <button
                    ...
                    className={`flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-100 dark:bg-slate-700 text-slate-800 dark:text-slate-200 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors font-semibold text-sm ${isMobile ? 'flex-1' : ''}`}
                >
            ...
            <div className="relative" ref={moreMenuRef}>
                <button
                    ...
                    className="w-9 h-9 sm:w-10 sm:h-10 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors flex items-center justify-center flex-shrink-0"
                >
                ...
                {/* Dropdown Menu */}
                {showMoreMenu && (
                    <div className="hidden sm:block absolute right-0 top-12 w-56 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 py-2 z-50">
                        <Link
                            href="/organizer"
    ...
    return (
        <div className="bg-white dark:bg-slate-800 shadow-sm transition-colors">
            ...
            <div className="relative max-w-5xl mx-auto">
                {/* Cover Photo */}
                <div className="relative h-[140px] sm:h-[180px] md:h-[300px] bg-gradient-to-r from-[#f49700] via-[#d98600] to-[#c47700] rounded-b-lg overflow-hidden">
                    {coverUrl && (
                        <Image
                            src={coverUrl}
                            alt="Cover photo"
                ...
                <div className="relative px-3 sm:px-4 md:px-8 pb-3 sm:pb-4">
                    <div className="flex flex-col md:flex-row md:items-end gap-2 sm:gap-4">
                        ...
                        <div className="relative -mt-12 sm:-mt-16 md:-mt-24 flex-shrink-0 mx-auto md:mx-0">
                            <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-44 md:h-44 rounded-full border-4 border-white dark:border-slate-800 shadow-lg overflow-hidden bg-white dark:bg-slate-700">
                                {avatarUrl ? (
                                    <Image
                                        src={avatarUrl}
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-[#f49700] to-[#d98600] flex items-center justify-center text-white text-4xl md:text-6xl font-bold">
                                        {getInitials()}
                                    </div>
                                )}
                            </div>
                ...
                <div className="sm:hidden fixed inset-0 z-50">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-slate-800 rounded-t-2xl shadow-xl animate-slide-up">
                        ...
                        <div className="py-1 px-3">
                            <Link
                                href="/organizer"
                                className="w-full px-3 py-2.5 text-left text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 flex items-center gap-3 rounded-lg"
                                onClick={() => setShowMoreMenu(false)}
                            >
                            ...
                            <div className="border-t border-slate-200 dark:border-slate-700 my-1.5 mx-2" />

                            <Link
                                href="/logout"
                                className="w-full px-3 py-2.5 text-left text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 flex items-center gap-3 rounded-lg"
                                onClick={() => setShowMoreMenu(false)}
                            >
                        ...
                        <div className="px-4 pt-2 pb-5">
                            <button
                                onClick={() => setShowMoreMenu(false)}
                                className="w-full py-2.5 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 font-medium text-sm rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors"
                            >
                                Cancel
                            </button>
                        </div>
