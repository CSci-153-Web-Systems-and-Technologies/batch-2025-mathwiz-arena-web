                            ...
                            <div className="lg:col-span-2">
                                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden h-full transition-colors">
                                    <div className="p-4 h-full flex flex-col">
                                        ...
                                        {/* Bio Textbox */}
                                        <div className="bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg p-4 mb-4 min-h-[80px] flex items-center justify-center transition-colors">
                                        ...
                                        <div className="flex-1 flex flex-col justify-evenly space-y-3">
                                            ...
                                            <div className="flex items-center gap-3 text-slate-600 dark:text-slate-400">
                                                ...
                                                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#f49700]/10 text-[#f49700]">
                                                    Organizer
                                                </span>
                                            </div>
                                        </div>
