...
export default function OrganizerStatisticsCard({ stats }: OrganizerStatisticsCardProps) {
    return (
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden h-full transition-colors">
            <div className="p-4">
                <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Statistics</h2>

                {/* Main Stats Grid */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    {/* Total Competitions */}
                    <div className="bg-[#f49700]/5 dark:bg-[#f49700]/10 rounded-xl p-4 text-center">
                        <div className="w-10 h-10 bg-[#f49700]/10 dark:bg-[#f49700]/20 rounded-lg flex items-center justify-center mx-auto mb-2">
                        ...
                        <p className="text-2xl font-bold text-slate-900 dark:text-white">{stats.totalCompetitions}</p>
                    ...
                    <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 text-center">
                        ...
                        <p className="text-2xl font-bold text-slate-900 dark:text-white">{stats.publishedCompetitions}</p>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 text-center">
                        ...
                        <p className="text-2xl font-bold text-slate-900 dark:text-white">{stats.totalParticipants}</p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-4">
                        <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">Competition Status</h3>
                    ...
                    {/* Highlights */}
                    <div className="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-4">
                        <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">Highlights</h3>
                ...
                {stats.totalCompetitions === 0 && (
                    <div className="text-center py-6 bg-slate-50 dark:bg-slate-700/50 rounded-xl">
                        <div className="w-16 h-16 bg-[#f49700]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#f49700]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                            </svg>
                        </div>
                        <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">No competitions yet</h3>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                            Create your first competition to start building your organizer profile!
                        </p>
                        <a
                            href="/organizer/competition/create"
                            className="inline-flex items-center gap-2 px-4 py-2 bg-[#f49700] text-white font-medium rounded-lg hover:bg-[#d68400] transition-colors"
                        >
