      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            />
            <p className="mt-1 text-xs text-slate-500">Minimum 3 characters, maximum 50 characters</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:bg-slate-50"
            />
            <p className="mt-1 text-xs text-slate-500">Minimum 2, maximum 10 members</p>
          </div>
