          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800">{completedAttempts.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800">{totalScore}</p>
              </div>
            </div>
          </div>
        ...
        {attempts && attempts.length > 0 ? (
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-200">
              <h2 className="text-lg font-semibold text-slate-800">All Attempts</h2>
            </div>
            <div className="divide-y divide-slate-200">
              {attempts.map((attempt) => {
                const competition = attempt.competitions as any;
                return (
                  <div key={attempt.id} className="px-6 py-4 hover:bg-slate-50 transition-colors">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          ...
                          <p className="text-2xl font-bold text-[#25346A]">{attempt.total_score}</p>
                        </div>
                        {attempt.is_completed ? (
                          <Link
