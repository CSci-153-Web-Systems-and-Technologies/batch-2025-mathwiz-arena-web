        ...
        return (
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm animate-pulse">
                <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-slate-200">
                    <div className="h-5 sm:h-6 bg-slate-200 rounded w-24 sm:w-32"></div>
                    <div className="h-3 sm:h-4 bg-slate-100 rounded w-36 sm:w-48 mt-2"></div>
                </div>
                <div className="p-4 sm:p-6">
                    <div className="grid grid-cols-3 gap-2 sm:gap-4">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="h-16 sm:h-24 bg-slate-100 rounded-xl"></div>
                        ))}
                    </div>
                </div>
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm transition-colors">
            <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-slate-200 dark:border-slate-700">
                ...
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-1">
                    Customize how MathWiz Arena looks
                </p>
            </div>
            <div className="p-4 sm:p-6">
                <div className="grid grid-cols-3 gap-2 sm:gap-4">
                    {themeOptions.map((option) => (
                        <button
                            ...
                            className={`relative p-2 sm:p-4 rounded-xl border-2 transition-all text-left ${theme === option.value
                        ...
                        >
                            ...
                            {theme === option.value && (
                                <div className="absolute top-1 right-1 sm:top-2 sm:right-2">
                                    <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-[#25346A] flex items-center justify-center">
                            ...
                            <p className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 mt-0.5 sm:mt-1 hidden sm:block">
                                {option.description}
                            </p>
                        </button>
                    ))}
