                            ...
                            <div className="lg:col-span-2">
                                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden h-full">
                                    <div className="p-3 sm:p-4 h-full flex flex-col">
                                        ...
                                        {/* Bio Textbox */}
                                        <div className="bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4 min-h-[60px] sm:min-h-[80px] flex items-center justify-center">
                                        ...
                                        <div className="flex-1 flex flex-col justify-evenly gap-2 sm:gap-0">
                                            {profile?.school && (
                                                <div className="flex items-center gap-2 sm:gap-3 text-slate-600 dark:text-slate-400">
                                                    ...
                                                    <span className="text-xs sm:text-sm">Studies at <strong className="text-slate-900 dark:text-white">{profile.school}</strong></span>
                                                </div>
                                            )}
