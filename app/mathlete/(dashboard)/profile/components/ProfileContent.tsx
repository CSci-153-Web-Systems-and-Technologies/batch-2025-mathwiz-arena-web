                            ...
                            <div className="lg:col-span-2">
                                <div className="bg-white rounded-xl shadow-sm overflow-hidden h-full">
                                    <div className="p-4 h-full flex flex-col">
                                        <h2 className="text-xl font-bold text-slate-900 mb-3">Intro</h2>

                                        {/* Bio Textbox */}
                                        <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 mb-4 min-h-[80px] flex items-center justify-center">
