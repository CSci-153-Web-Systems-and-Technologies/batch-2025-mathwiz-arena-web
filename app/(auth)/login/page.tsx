      ...
      <header className="w-full fixed top-0 z-50 bg-white/95 dark:bg-slate-950/95 backdrop-blur-sm border-b border-slate-100 dark:border-slate-800 transition-all duration-300">
        <div className="mx-auto max-w-7xl flex items-center justify-between p-3 lg:p-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4 md:gap-6">
            ...
            <Link href="/signup" className="hidden sm:block text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-[#1B2559] dark:hover:text-white transition-colors">
              Need an account? <span className="font-bold text-[#F49700] hover:text-orange-600">Sign up</span>
            </Link>
          </div>
        </div>
      </header>
