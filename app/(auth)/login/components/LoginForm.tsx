...
export function LoginForm() {
  ...
  return (
    <Card className="mx-auto max-w-md w-full shadow-xl shadow-blue-900/10 border-slate-200 dark:border-slate-800 dark:bg-slate-900 dark:shadow-none overflow-hidden rounded-xl sm:rounded-2xl">
      <CardHeader className="space-y-1 text-center pb-6 sm:pb-8 pt-6 sm:pt-8 px-4 sm:px-6">
        <CardTitle className="text-2xl sm:text-3xl font-bold text-[#1B2559] dark:text-white">Welcome back</CardTitle>
      ...
      <CardContent className="px-4 sm:px-8 pb-6 sm:pb-8">
        <div className="grid gap-4 sm:gap-6">
          {error && (
            <div className="bg-red-50 border border-red-200 text-red-700 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm flex items-start gap-2 sm:gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 sm:mt-1">{error}</p>
              </div>
            </div>
          )}
          ...
          <div className="bg-blue-50/50 border border-blue-100 text-[#1B2559] px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm flex items-start gap-2 sm:gap-3 dark:bg-blue-900/20 dark:border-blue-800 dark:text-blue-100">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 mt-0.5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <div>
              <p className="font-bold">Google Sign-In Only</p>
              <p className="mt-0.5 sm:mt-1 text-slate-600 dark:text-slate-300">Please use Google to sign in.</p>
            </div>
          </div>
