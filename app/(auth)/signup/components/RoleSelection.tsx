    ...
    <Card className="mx-auto max-w-2xl w-full shadow-xl">
      ...
      <CardContent>
        <form action={signInWithGoogle}>
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 rounded-lg border-2 border-slate-300 bg-white px-6 py-4 font-medium text-slate-700 transition-all hover:border-[#25346A] hover:bg-slate-50"
          >
        ...
        <div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-lg text-sm mt-6">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="mt-1">After signing in, you'll select whether you're a Mathlete or Organizer.</p>
            </div>
          </div>
        </div>
